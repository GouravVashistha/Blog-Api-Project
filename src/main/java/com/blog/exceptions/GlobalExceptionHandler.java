...
//this  annotation handle the Exception
...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<ApiResponce> emailAlreadyExistExceptionhandler(EmailAlreadyExistException ex) {
		String message = ex.getMessage();
		ApiResponce apiResponse = new ApiResponce(message, false);
		return new ResponseEntity<ApiResponce>(apiResponse, HttpStatus.NOT_FOUND);
	}
	...
	public ResponseEntity<ApiResponce> DetailNotFoundExceptionhandler(DetailsNotFoundException ex) {
		String message = ex.getMessage();
		ApiResponce apiResponse = new ApiResponce(message, false);
		return new ResponseEntity<ApiResponce>(apiResponse, HttpStatus.NOT_FOUND);
	}
